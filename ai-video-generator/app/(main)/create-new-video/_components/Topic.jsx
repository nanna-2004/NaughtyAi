...
function Topic({ onHandleInputChange, isImagePage = false, onScriptsGenerated }) {
    ...
    <div className="container-box">
      <div className="mt-4">
        <h2 className="sub-heading">
          {isImagePage ? "🎨 Image Topic" : "🎨 Video Topic"}
        </h2>
        ...
        <Tabs defaultValue="suggestions" className="w-full">
          ...
          <TabsContent value="your_topic">
            <div className="space-y-2">
              ...
              <Input
                placeholder="E.g., A Time-Traveling Chef in Cyberpunk Tokyo"
                value={selectedTopic}
                onChange={(e) => {
      ...
      {scripts &&
        scripts.map((script, index) => (
          <div
            ...
            className={`mt-4 p-4 border rounded-md cursor-pointer bg-gray-100 dark:bg-gray-900 text-black dark:text-white max-h-[300px] overflow-y-auto ${
              selectedScriptIndex === index ? "border-white bg-secondary" : ""
            }`}
          >
            <h3 className="font-semibold mb-2">🎞️ Script {index + 1}</h3>
